...
function clearFieldErrors(formElement) {
    ["nombre", "empresa", "email", "telefono", "perfil", "interes", "mensaje", "acepta_privacidad"].forEach((fieldName) => {
...
function validateTrainingFields(formElement) {
    ...
    const privacyField = formElement.elements.namedItem("acepta_privacidad");
    ...
    if (privacyField && !privacyField.checked) {
        setFieldError(privacyField, t("training-error-privacy"));
        return false;
    }
...
if (form && statusEl && submitBtn) {
    ...
    form.addEventListener("submit", async (event) => {
        ...
        // Control de Honeypot Anti-Spam: si está relleno es un bot de spam.
        // Droppeamos la petición de forma silenciosa simulando éxito para engañarlos.
